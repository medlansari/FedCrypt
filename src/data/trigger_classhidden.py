...
from src.setting import TRANSFORM_TEST_MNIST, TRANSFORM_TEST


class ClassHiddenTrigger(Dataset):
    """
    ...
    def __init__(self, num_classes, RGB=True):
        """
        ...
        """
        self.images_path = "./trigger_sets/CWAFFLE/"
        ...
        for class_path in file_list:
            ...
            for img_path in glob.glob(class_path + "/*.png"):
                self.data.append([img_path, torch.tensor(num_classes )])
